        ...
        <div class="text-warning text-center pt-5" id="sesi2" >
            <div class="row">
                <div class="col-sm-12 text-center">
                    <?php 
                    $query = mysqli_query($koneksi,"SELECT * FROM tbsoal where no_soal = 3 AND kategori = ".$_SESSION['kategori']." AND jenis = ".$_SESSION['jenis']);
                    $fetch = mysqli_fetch_array($query);
                     $query = mysqli_query($koneksi,"SELECT * FROM deskripsi_gambar where no_soal = 3 AND kategori = ".$_SESSION['kategori']);
